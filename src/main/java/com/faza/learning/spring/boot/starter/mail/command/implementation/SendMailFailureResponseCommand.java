...
public class SendMailFailureResponseCommand implements SendMailResponseCommand {

    private String message;

    public SendMailFailureResponseCommand(String message) {
        this.message = message;
    }

    @Override
    public SendMailResponse execute() {
        return ProvideSendMailResponse.provideSendMailFailureResponse(message);
    }
}
